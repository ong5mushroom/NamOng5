                ...
                <div class="space-y-2">
                    ...
                    <div class="bg-white p-3 rounded-lg shadow-sm border border-slate-100 flex justify-between items-center hover:border-blue-200 transition relative overflow-hidden">
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            ${isAdmin ? `<div class="flex flex-col gap-1"><button onclick="window.HR_Action.score('${e._id}','${e.name}',10,'${user.name}')" class="w-6 h-6 bg-green-50 text-green-600 rounded flex items-center justify-center font-bold text-xs hover:bg-green-100 shadow-sm">+</button><button onclick="window.HR_Action.score('${e._id}','${e.name}',-10,'${user.name}')" class="w-6 h-6 bg-red-50 text-red-600 rounded flex items-center justify-center font-bold text-xs hover:bg-red-100 shadow-sm">-</button></div>` : ''}
                        </div>
                    </div>`).join('')}
                </div>
            </div>
