...
export const THDG = {
    render: (data, user) => {
        ...
        try {
            ...
            // Phân loại sản phẩm (Bảo vệ p tồn tại)
                ...
                <div id="zone-th-in" class="glass p-5 border-l-4 border-green-500 animate-pop">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="bg-orange-50 p-3 rounded-xl border border-orange-100">
                            <h4 class="text-[10px] font-bold text-orange-700 uppercase mb-2">2. Nấm Khô</h4>
                            <div class="grid grid-cols-3 gap-3">
                        ...
                        <div class="bg-purple-50 p-3 rounded-xl border border-purple-100">
                            <h4 class="text-[10px] font-bold text-purple-700 uppercase mb-2">3. Sơ Chế</h4>
                            <div class="grid grid-cols-3 gap-3">
            ...
            setTimeout(() => {
                ...
                if(btnAddProd) {
                    btnAddProd.onclick = () => {
                         Utils.modal("Thêm Mã Hàng Mới", `<div><label class="text-xs font-bold text-slate-500">Tên</label><input id="new-prod-name" class="w-full p-2 border rounded font-bold"></div><div><label class="text-xs font-bold text-slate-500">Mã (ko dấu)</label><input id="new-prod-code" class="w-full p-2 border rounded"></div><div><select id="new-prod-group" class="w-full p-2 border rounded"><option value="1">1. Tươi</option><option value="2">2. Khô</option><option value="3">3. Sơ Chế</option></select></div>`, [{id:'submit-new-prod', text:'Lưu Mã'}]);
